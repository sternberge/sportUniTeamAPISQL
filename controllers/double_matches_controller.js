...
module.exports = {
  ...
  getMatchsByYearSpringFallGender (req, res) {
    ...
    db.pool.getConnection((error, connection) => {
      ...
      // L'ajout du '?' permet d'éviter les injections sql
      var query = connection.query('SELECT concat(u1.firstName,\' \',u1.lastName) as winnerName1,concat(u2.firstName,\' \',u2.lastName) as winnerName2,concat(u3.firstName,\' \',u3.lastName) as loserName1, concat(u4.firstName,\' \',u4.lastName) as loserName2,p1.playerId as winner1Id,p2.playerId as winner2Id,p3.playerId as loser1Id,p4.playerId as loser2Id,dm.* FROM DoubleMatches dm INNER JOIN DoubleTeams dt1 on dm.winnerDouble = dt1.doubleTeamId INNER JOIN DoubleTeams dt2 on dm.loserDouble = dt2.doubleTeamId INNER JOIN Players p1 on p1.playerId = dt1.Players_playerId INNER JOIN Players p2 on p2.playerId =  dt1.Players_playerId2 INNER JOIN Players p3 on p3.playerId =  dt2.Players_playerId INNER JOIN Players p4 on p4.playerId =  dt2.Players_playerId2 INNER JOIN Users u1 on u1.userId = p1.Users_userId INNER JOIN Users u2 on u2.userId = p2.Users_userId INNER JOIN Users u3 on u3.userId = p3.Users_userId INNER JOIN Users u4 on u4.userId = p4.Users_userId INNER JOIN Teams t1 on t1.teamId = p1.Teams_teamId INNER JOIN Teams t2 on t2.teamId = p2.Teams_teamId INNER JOIN Teams t3 on t3.teamId = p3.Teams_teamId INNER JOIN Teams t4 on t4.teamId = p4.Teams_teamId INNER JOIN Colleges c1 on c1.collegeId = t1.Colleges_collegeId INNER JOIN Colleges c2 on c2.collegeId = t2.Colleges_collegeId INNER JOIN Colleges c3 on c3.collegeId = t3.Colleges_collegeId INNER JOIN Colleges c4 on c4.collegeId = t4.Colleges_collegeId WHERE (t1.gender LIKE ? AND t2.gender LIKE ? AND t3.gender LIKE ? AND t4.gender LIKE ?) AND dm.springFall = ? AND dm.date >= \'?-09-01\' AND dm.date <= \'?-06-30\' ORDER BY dm.date DESC', [gender,gender,gender,gender,springFall,year,yearPlusOne], (error, results, fields) => {
        if (error){
          connection.release();
          return res.send(JSON.stringify({"status": 500, "error": error, "response": null}));
        }
  ...
  getMatchsByYearSpringFallGenderCollege (req, res) {
    ...
    db.pool.getConnection((error, connection) => {
      ...
      // L'ajout du '?' permet d'éviter les injections sql
      var query = connection.query('SELECT concat(u1.firstName,\' \',u1.lastName) as winnerName1,concat(u2.firstName,\' \',u2.lastName) as winnerName2,concat(u3.firstName,\' \',u3.lastName) as loserName1, concat(u4.firstName,\' \',u4.lastName) as loserName2,p1.playerId as winner1Id,p2.playerId as winner2Id,p3.playerId as loser1Id,p4.playerId as loser2Id,dm.* FROM DoubleMatches dm INNER JOIN DoubleTeams dt1 on dm.winnerDouble = dt1.doubleTeamId INNER JOIN DoubleTeams dt2 on dm.loserDouble = dt2.doubleTeamId INNER JOIN Players p1 on p1.playerId =  dt1.Players_playerId INNER JOIN Players p2 on p2.playerId =  dt1.Players_playerId2 INNER JOIN Players p3 on p3.playerId =  dt2.Players_playerId INNER JOIN Players p4 on p4.playerId =  dt2.Players_playerId2 INNER JOIN Users u1 on u1.userId = p1.Users_userId INNER JOIN Users u2 on u2.userId = p2.Users_userId INNER JOIN Users u3 on u3.userId = p3.Users_userId INNER JOIN Users u4 on u4.userId = p4.Users_userId INNER JOIN Teams t1 on t1.teamId = p1.Teams_teamId INNER JOIN Teams t2 on t2.teamId = p2.Teams_teamId INNER JOIN Teams t3 on t3.teamId = p3.Teams_teamId INNER JOIN Teams t4 on t4.teamId = p4.Teams_teamId INNER JOIN Colleges c1 on c1.collegeId = t1.Colleges_collegeId INNER JOIN Colleges c2 on c2.collegeId = t2.Colleges_collegeId INNER JOIN Colleges c3 on c3.collegeId = t3.Colleges_collegeId INNER JOIN Colleges c4 on c4.collegeId = t4.Colleges_collegeId WHERE (t1.gender LIKE ? AND t2.gender LIKE ? AND t3.gender LIKE ? AND t4.gender LIKE ?) AND dm.springFall = ? AND dm.date >= \'?-09-01\' AND dm.date <= \'?-06-30\' AND (c1.collegeId = ? OR c1.collegeId = ? OR c1.collegeId = ? OR c1.collegeId = ?) ORDER BY dm.date DESC', [gender,gender,gender,gender,springFall,year,yearPlusOne,collegeId,collegeId,collegeId,collegeId], (error, results, fields) => {
        if (error){
          connection.release();
          return res.send(JSON.stringify({"status": 500, "error": error, "response": null}));
        }
  ...
  getMatchsByYearSpringFallPlayer1Player2(req, res) {
    ...
    db.pool.getConnection((error, connection) => {
      ...
      // L'ajout du '?' permet d'éviter les injections sql
      var query = connection.query(`SELECT concat(u1.firstName,' ',u1.lastName) as winnerName1,concat(u2.firstName,' ',u2.lastName) as winnerName2,concat(u3.firstName,' ',u3.lastName) as loserName1, concat(u4.firstName,' ',u4.lastName) as loserName2,p1.playerId as winner1Id,p2.playerId as winner2Id,p3.playerId as loser1Id,p4.playerId as loser2Id,dm.*,c1.Conferences_conferenceId
...
`, [springFall,year,yearPlusOne,playerId1,playerId2,playerId2,playerId1,playerId1,playerId2,playerId2,playerId1], (error, results, fields) => {
  ...
  getMatchsByYearSpringFallGenderTournamentPlayer1Player2(req, res) {
    ...
    db.pool.getConnection((error, connection) => {
      ...
      // L'ajout du '?' permet d'éviter les injections sql
      var query = connection.query('SELECT concat(u1.firstName,\' \',u1.lastName) as winnerName1,concat(u2.firstName,\' \',u2.lastName) as winnerName2,concat(u3.firstName,\' \',u3.lastName) as loserName1, concat(u4.firstName,\' \',u4.lastName) as loserName2,p1.playerId as winner1Id,p2.playerId as winner2Id,p3.playerId as loser1Id,p4.playerId as loser2Id,dm.*,c1.Conferences_conferenceId FROM DoubleMatches dm INNER JOIN DoubleTeams dt1 on dm.winnerDouble = dt1.doubleTeamId INNER JOIN DoubleTeams dt2 on dm.loserDouble = dt2.doubleTeamId INNER JOIN Players p1 on p1.playerId =  dt1.Players_playerId INNER JOIN Players p2 on p2.playerId =  dt1.Players_playerId2 INNER JOIN Players p3 on p3.playerId =  dt2.Players_playerId INNER JOIN Players p4 on p4.playerId =  dt2.Players_playerId2 INNER JOIN Users u1 on u1.userId = p1.Users_userId INNER JOIN Users u2 on u2.userId = p2.Users_userId INNER JOIN Users u3 on u3.userId = p3.Users_userId INNER JOIN Users u4 on u4.userId = p4.Users_userId INNER JOIN Teams t1 on t1.teamId = p1.Teams_teamId INNER JOIN Teams t2 on t2.teamId = p2.Teams_teamId INNER JOIN Teams t3 on t3.teamId = p3.Teams_teamId INNER JOIN Teams t4 on t4.teamId = p4.Teams_teamId INNER JOIN Colleges c1 on c1.collegeId = t1.Colleges_collegeId INNER JOIN Colleges c2 on c2.collegeId = t2.Colleges_collegeId INNER JOIN Colleges c3 on c3.collegeId = t3.Colleges_collegeId INNER JOIN Colleges c4 on c4.collegeId = t4.Colleges_collegeId WHERE dm.springFall = ?  AND dm.date >= \'?-09-01\' AND dm.date <= \'?-06-30\' AND dm.Tournaments_tournamentId = ?  AND  AND (dt1.Players_playerId = ? AND dt1.Players_playerId2 = ?) OR (dt1.Players_playerId2 = ? AND dt1.Players_playerId = ?) OR (dt2.Players_playerId = ? AND dt2.Players_playerId2 = ?) OR (dt2.Players_playerId2 = ? AND dt2.Players_playerId = ?)  ORDER BY dm.date DESC', [springFall,year,yearPlusOne,tournamentId,playerId1,playerId2,playerId2,playerId1,playerId1,playerId2,playerId2,playerId1], (error, results, fields) => {
        if (error){
          connection.release();
          return res.send(JSON.stringify({"status": 500, "error": error, "response": null}));
        }
